...
$.get({
url: "https://www.omdbapi.com/?s="+searchTerm+"&type=movie&apikey=4fc541c6",
...
"</tr>");
$("#detail-view").append("<a data-toggle='collapse'
href='#"+detail[i]["imdbID"]+"'>"+
"<img src='"+detail[i]["Poster"]+"'
title='"+detail[i]["Title"]+"'></img></a>");
}
for(var i=0; i<detail.length; i++){
$("#detail-view").append("<div class='collapse'
id='"+detail[i]["imdbID"]+"'>"+
"<div class='card card-body'>"+
"<h4>"+detail[i]["Title"]+
" <span class='badge badge-dark'>"+detail[i]["Rated"]+"</span>"+
" <span class='badge
badge-secondary'>"+detail[i]["Runtime"]+"</span></h4>"+
"<div class='container'><div class='row'>"+
"<div class='col-lg-3 col-md-5 col-sm-6'>"+
"<img src='"+detail[i]["Poster"]+"'
title='"+detail[i]["Title"]+"'></img></div>"+
...
"<p><b>IMDb link: </b><a
href='https://www.imdb.com/title/"+detail[i]["imdbID"]+
